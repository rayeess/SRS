...
<body>
	...
	<header>	
		...
		<div class="navbar navbar-inverse navbar-static-top">
			...
			<div class="container">
		<!-- {{ URL::route('index') }} -->
				<a href="#" class="navbar-brand"><img src="img/example.jpg"style="width:50px;height:30px;margin-left:50px;"><small></small></a>
				...
				<div class="collapse navbar-collapse navHeadercollapse">
					...
					<ul  class=" nav navbar-nav navbar-right">
						...
						<li id="nav" class="#"><a href="#"><span class="glyphicon glyphicon-home"> Home </span></a></li>
						...
						<li id="nav"><a href="#"> <span class="glyphicon glyphicon-envelope"> Contact<span></a></li>
							...
							<!-- {{ URL::route('user') }}-->
					<li id="nav"><a href="#"><span class="glyphicon glyphicon-user"style="color:green;"> User</span>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<h2 style="margin-left:100px; color:;">Register<span class="glyphicon glyphicon-pencil"style="color:green;"></span></h2>
															...
															<!--action="{{ URL::route('signup-post') }}" method="post"					
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
							<input type="text" class="form-control" name="Surname" placeholder="Second Name" style="width:200px; margin-left:0px;margin-bottom:8px">					
								</div>
							</div>
							...
							<input type="text" class="form-control" name="Phone" placeholder="Phone" style="width:200px; margin-left:0px;margin-bottom:8px">					
							  ...
							  <div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
								  <a type="submit" class="btn btn-default" style="width:90px; margin-top:20px;margin-left:30px;margin-bottom; border-color:green;"><span class="glyphicon glyphicon-pencil"style="color:green;"></span>Register</a>
								</div>
							  </div>
						</form>
